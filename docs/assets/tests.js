...
define('humans/tests/integration/components/app-intro-section-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | app-intro-section', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "MGauw0TQ",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"app-intro-section\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Ilbm6QLl",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"app-intro-section\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/app-nav-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | app-nav', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "kGcBe/Mr",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"app-nav\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "0qMex6dA",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"app-nav\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/blockstack-intro-section-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | blockstack-intro-section', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "G1SO5MOP",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"blockstack-intro-section\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "JMdHuiUr",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"blockstack-intro-section\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/cover-section-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | cover-section', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Y0iWUTo/",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"cover-section\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "tAdzkOcu",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"cover-section\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/customize-url-section-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | customize-url-section', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "mQoCfdam",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"customize-url-section\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ZI3TdT0z",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"customize-url-section\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/edit-profile-welcome-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | edit-profile-welcome', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "hkpnqRgr",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"edit-profile-welcome\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ukGw/dCR",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"edit-profile-welcome\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/editable-view-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | editable-view', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "hBryKiBU",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"editable-view\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "zBgs0g0G",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"editable-view\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/integration/components/store-indicator-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | store-indicator', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Zg+btrHj",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"store-indicator\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "s7psmd1/",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"store-indicator\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('humans/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/app-intro-section.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/app-intro-section.js should pass ESLint\n\n');
  });

  QUnit.test('components/app-nav.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/app-nav.js should pass ESLint\n\n');
  });

  QUnit.test('components/blockstack-intro-section.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/blockstack-intro-section.js should pass ESLint\n\n');
  });

  QUnit.test('components/cover-section.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/cover-section.js should pass ESLint\n\n');
  });

  QUnit.test('components/customize-url-section.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/customize-url-section.js should pass ESLint\n\n');
  });

  QUnit.test('components/edit-profile-welcome.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/edit-profile-welcome.js should pass ESLint\n\n');
  });

  QUnit.test('components/editable-view.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/editable-view.js should pass ESLint\n\n52:18 - Don\'t use Ember\'s function prototype extensions (ember/no-function-prototype-extensions)');
  });
  ...
  QUnit.test('controllers/customize-url.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/customize-url.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('models/human.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/human.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/create-profile.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/create-profile.js should pass ESLint\n\n');
  });

  QUnit.test('routes/human.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/human.js should pass ESLint\n\n');
  });

  QUnit.test('services/nav.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/nav.js should pass ESLint\n\n');
  });
...
define('humans/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('humans/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/components/app-intro-section.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/app-intro-section.hbs should pass TemplateLint.\n\nhumans/templates/components/app-intro-section.hbs\n  2:2  error  img tags must have an alt attribute  img-alt-attributes\n  3:2  error  img tags must have an alt attribute  img-alt-attributes\n  2:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  3:2  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('humans/templates/components/app-nav.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/app-nav.hbs should pass TemplateLint.\n\nhumans/templates/components/app-nav.hbs\n  7:15  error  Incorrect indentation of positional param \'human\' beginning at L7:C15. Expected \'human\' to be at L8:C6.  attribute-indentation\n  7:23  error  Incorrect indentation of positional param \'session.human.blockstackName\' beginning at L7:C23. Expected \'session.human.blockstackName\' to be at L9:C6.  attribute-indentation\n  7:52  error  Incorrect indentation of attribute \'title\' beginning at L7:C52. Expected \'title\' to be at L10:C6.  attribute-indentation\n  7:80  error  Incorrect indentation of attribute \'tabindex\' beginning at L7:C80. Expected \'tabindex\' to be at L11:C6.  attribute-indentation\n  7:93  error  Incorrect indentation of attribute \'target\' beginning at L7:C93. Expected \'target\' to be at L12:C6.  attribute-indentation\n  7:108  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{link-to}}\' beginning at L7:C108. Expected \'{{link-to}}\' to be at L13:C4.  attribute-indentation\n');
  });

  QUnit.test('humans/templates/components/blockstack-intro-section.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/blockstack-intro-section.hbs should pass TemplateLint.\n\nhumans/templates/components/blockstack-intro-section.hbs\n  2:2  error  img tags must have an alt attribute  img-alt-attributes\n  3:2  error  img tags must have an alt attribute  img-alt-attributes\n  2:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  3:2  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('humans/templates/components/cover-section.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/cover-section.hbs should pass TemplateLint.\n\nhumans/templates/components/cover-section.hbs\n  2:18  error  Incorrect indentation of attribute \'editable\' beginning at L2:C18. Expected \'editable\' to be at L3:C4.  attribute-indentation\n  2:36  error  Incorrect indentation of attribute \'tagName\' beginning at L2:C36. Expected \'tagName\' to be at L4:C4.  attribute-indentation\n  2:49  error  Incorrect indentation of attribute \'model\' beginning at L2:C49. Expected \'model\' to be at L5:C4.  attribute-indentation\n  2:61  error  Incorrect indentation of attribute \'name\' beginning at L2:C61. Expected \'name\' to be at L6:C4.  attribute-indentation\n  2:78  error  Incorrect indentation of attribute \'placeholder\' beginning at L2:C78. Expected \'placeholder\' to be at L7:C4.  attribute-indentation\n  2:97  error  Incorrect indentation of attribute \'spellcheck\' beginning at L2:C97. Expected \'spellcheck\' to be at L8:C4.  attribute-indentation\n  2:114  error  Incorrect indentation of attribute \'value\' beginning at L2:C114. Expected \'value\' to be at L9:C4.  attribute-indentation\n  2:130  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{editable-view}}\' beginning at L2:C130. Expected \'{{editable-view}}\' to be at L10:C2.  attribute-indentation\n  3:18  error  Incorrect indentation of attribute \'class\' beginning at L3:C18. Expected \'class\' to be at L4:C4.  attribute-indentation\n  3:36  error  Incorrect indentation of attribute \'editable\' beginning at L3:C36. Expected \'editable\' to be at L5:C4.  attribute-indentation\n  3:54  error  Incorrect indentation of attribute \'model\' beginning at L3:C54. Expected \'model\' to be at L6:C4.  attribute-indentation\n  3:66  error  Incorrect indentation of attribute \'name\' beginning at L3:C66. Expected \'name\' to be at L7:C4.  attribute-indentation\n  3:85  error  Incorrect indentation of attribute \'placeholder\' beginning at L3:C85. Expected \'placeholder\' to be at L8:C4.  attribute-indentation\n  3:111  error  Incorrect indentation of attribute \'spellcheck\' beginning at L3:C111. Expected \'spellcheck\' to be at L9:C4.  attribute-indentation\n  3:128  error  Incorrect indentation of attribute \'value\' beginning at L3:C128. Expected \'value\' to be at L10:C4.  attribute-indentation\n  3:151  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{editable-view}}\' beginning at L3:C151. Expected \'{{editable-view}}\' to be at L11:C2.  attribute-indentation\n');
  });

  QUnit.test('humans/templates/components/customize-url-section.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/customize-url-section.hbs should pass TemplateLint.\n\nhumans/templates/components/customize-url-section.hbs\n  5:115  error  Incorrect indentation of htmlAttribute \'href\' beginning at L5:C115. Expected \'href\' to be at L6:C4.  attribute-indentation\n  5:229  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L5:C229. Expected \'<a>\' to be at L7:C2.  attribute-indentation\n  5:241  error  Incorrect indentation of close tag \'</a>\' for element \'<a>\' beginning at L5:C241. Expected \'</a>\' to be at L5:C112.  attribute-indentation\n');
  });

  QUnit.test('humans/templates/components/edit-profile-welcome.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/components/edit-profile-welcome.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/components/editable-view.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/components/editable-view.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/components/store-indicator.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/components/store-indicator.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/create-profile.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/create-profile.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/customize-url.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/customize-url.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/human.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/human.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/index.hbs should pass TemplateLint.\n\n');
  });
});
define('humans/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/app-intro-section-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/app-intro-section-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/app-nav-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/app-nav-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/blockstack-intro-section-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/blockstack-intro-section-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/cover-section-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/cover-section-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/customize-url-section-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/customize-url-section-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/edit-profile-welcome-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/edit-profile-welcome-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/editable-view-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/editable-view-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/store-indicator-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/store-indicator-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/customize-url-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/customize-url-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/initializers/dns-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/initializers/dns-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/initializers/inflector-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/initializers/inflector-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/create-profile-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/create-profile-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/customize-url-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/customize-url-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/human-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/human-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/services/nav-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/nav-test.js should pass ESLint\n\n');
  });
...
define('humans/tests/test-helper', ['humans/app', 'humans/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/controllers/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/controllers/customize-url-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | customize-url', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:customize-url');
      assert.ok(controller);
    });
  });
});
define('humans/tests/unit/controllers/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/initializers/dns-test', ['humans/initializers/dns', 'qunit', 'ember-qunit'], function (_dns, _qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Initializer | dns', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('humans/tests/unit/initializers/inflector-test', ['humans/initializers/inflector', 'qunit', 'ember-qunit'], function (_inflector, _qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Initializer | inflector', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    ...
    hooks.beforeEach(function () {
      ...
      this.TestApplication.initializer({
        name: 'initializer under test',
        initialize: _inflector.initialize
      });
...
define('humans/tests/unit/routes/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/routes/create-profile-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | create-profile', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:create-profile');
      assert.ok(route);
    });
  });
});
define('humans/tests/unit/routes/customize-url-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | customize-url', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:customize-url');
      assert.ok(route);
    });
  });
});
define('humans/tests/unit/routes/human-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | human', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('humans/tests/unit/routes/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/services/nav-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | nav', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('humans/tests/unit/services/session-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('humans/tests/unit/services/store-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('humans/tests/test-helper');
