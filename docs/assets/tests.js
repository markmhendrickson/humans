...
define('humans/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/editable-view.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/editable-view.js should pass ESLint\n\n32:19 - \'event\' is defined but never used. (no-unused-vars)\n47:26 - \'Ember\' is not defined. (no-undef)\n50:18 - Don\'t use Ember\'s function prototype extensions (ember/no-function-prototype-extensions)\n51:5 - Use import { once } from \'@ember/runloop\'; instead of using Ember.run.once (ember/new-module-imports)\n51:5 - \'Ember\' is not defined. (no-undef)');
  });
  ...
  QUnit.test('services/session.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/session.js should pass ESLint\n\n27:38 - Irregular whitespace not allowed. (no-irregular-whitespace)\n30:38 - \'reject\' is defined but never used. (no-unused-vars)\n31:116 - \'error\' is defined but never used. (no-unused-vars)');
  });

  QUnit.test('services/store.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/store.js should pass ESLint\n\n1:8 - \'AppAdapter\' is defined but never used. (no-unused-vars)\n2:10 - \'computed\' is defined but never used. (no-unused-vars)\n7:3 - Call this._super(...arguments) in init hook (ember/require-super-in-init)');
  });
});
define('humans/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('humans/templates/components/app-nav.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'humans/templates/components/app-nav.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('humans/templates/components/blockstack-intro-section.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'humans/templates/components/blockstack-intro-section.hbs should pass TemplateLint.\n\nhumans/templates/components/blockstack-intro-section.hbs\n  8:2  error  img tags must have an alt attribute  img-alt-attributes\n  9:2  error  img tags must have an alt attribute  img-alt-attributes\n  8:2  error  Self-closing a void element is redundant  self-closing-void-elements\n  9:2  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });
