...
;define('humans/adapters/application', ['exports', 'ember-data', 'npm:blockstack', 'ember-inflector'], function (exports, _emberData, _npmBlockstack, _emberInflector) {
  ...
  exports.default = _emberData.default.JSONAPIAdapter.extend({
    createRecord(store, type, snapshot) {
      let path = `${_emberInflector.default.inflector.pluralize(type.modelName)}/${snapshot.id}`;
      let data = {};
      ...
      return new Promise((resolve, reject) => {
        _npmBlockstack.default.putFile(path, JSON.stringify(data), {
          encrypt: false
        }).then(() => {
          resolve(data);
        }).catch(reject);
...
;define('humans/components/customize-url-section', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Component.extend({
    classNames: ['customize-url-section', 'page'],
    tagName: 'section',
    ipAddress: '127.0.0.1',
    domain: 'humansapp.io'
  });
...
;define('humans/models/human', ['exports', 'ember-data/attr', 'ember-data', 'ember-data/relationships', 'ember-data/model', 'npm:blockstack'], function (exports, _attr, _emberData, _relationships, _model, _npmBlockstack) {
  'use strict';
...
;define('humans/router', ['exports', 'humans/config/environment'], function (exports, _environment) {
  'use strict';
...
;define('humans/routes/human', ['exports', 'npm:blockstack'], function (exports, _npmBlockstack) {
  'use strict';
  ...
  exports.default = Ember.Route.extend({
    ...
    model(params) {
      return new Promise((resolve, reject) => {
        _npmBlockstack.default.config.network.getNameInfo(params.blockstack_name).then(info => {
...
;define('humans/services/session', ['exports', 'ember-data', 'npm:blockstack'], function (exports, _emberData, _npmBlockstack) {
  ...
  exports.default = Ember.Service.extend({
    ...
    authenticate() {
      _npmBlockstack.default.redirectToSignIn();
    },
...
;define('humans/services/store', ['exports', 'humans/adapters/application', 'ember-data', 'npm:p-queue'], function (exports, _application, _emberData, _npmPQueue) {
  'use strict';
...
;define("humans/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "FxXJ+NBq", "block": "{\"symbols\":[],\"statements\":[[1,[21,\"app-nav\"],false],[0,\"\\n\"],[1,[21,\"outlet\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "humans/templates/application.hbs" } });
});
...
;define("humans/templates/components/app-nav", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "KaxhOtYb", "block": "{\"symbols\":[],\"statements\":[[4,\"link-to\",[\"index\"],[[\"tabindex\"],[\"1\"]],{\"statements\":[[0,\"Humans.\"]],\"parameters\":[]},null],[0,\"\\n\"],[7,\"div\"],[9],[0,\"\\n\"],[4,\"if\",[[23,[\"session\",\"unauthenticated\"]]],null,{\"statements\":[[0,\"    \"],[7,\"span\"],[12,\"onclick\",[27,\"action\",[[22,0,[]],\"authenticate\"],null]],[11,\"tabindex\",\"2\"],[9],[0,\"Manage existing profile\"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[4,\"link-to\",[\"human\",[23,[\"session\",\"human\",\"blockstackName\"]]],[[\"tabindex\"],[\"2\"]],{\"statements\":[[0,\"View public profile\"]],\"parameters\":[]},null],[0,\"\\n    \"],[4,\"link-to\",[\"customize-url\"],[[\"tabindex\"],[\"3\"]],{\"statements\":[[0,\"Customize URL\"]],\"parameters\":[]},null],[0,\"\\n    \"],[7,\"span\"],[11,\"tabindex\",\"4\"],[3,\"action\",[[22,0,[]],\"deauthenticate\"]],[9],[0,\"Sign out\"],[10],[0,\"\\n\"]],\"parameters\":[]}],[10]],\"hasEval\":false}", "meta": { "moduleName": "humans/templates/components/app-nav.hbs" } });
});
...
;define("humans/templates/components/edit-profile-welcome", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "2O7GTCNI", "block": "{\"symbols\":[],\"statements\":[[7,\"h2\"],[9],[0,\"Start creating!\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"Fill out your profile here and changes will be saved automatically to your new public profile.\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"Select \\\"View public profile\\\" to view your profile as it appears to others and share the URL with friends, etc.\"],[10],[0,\"\\n\"],[7,\"button\"],[3,\"action\",[[22,0,[]],\"dismiss\"]],[9],[0,\"Ok\"],[10],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "humans/templates/components/edit-profile-welcome.hbs" } });
});
...
;
          if (!runningTests) {
            require("humans/app")["default"].create({"name":"humans","version":"0.0.0+1584abf9"});
          }
